...
val MethodNode.refsIn: MutableList<MethodNode> by mixin(mutableListOf())
val MethodNode.refsOut: MutableList<MethodNode> by mixin(mutableListOf())
val MethodNode.fieldReadRefs: MutableList<FieldNode> by mixin(mutableListOf())
val MethodNode.fieldWriteRefs: MutableList<FieldNode> by mixin(mutableListOf())
val MethodNode.classRefs: MutableList<ClassNode> by mixin(mutableListOf())
